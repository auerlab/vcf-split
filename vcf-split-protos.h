...
int vcf_split(const char *argv[], FILE *vcf_infile, const char *prefix, size_t first_col, size_t last_col, id_list_t *selected_sample_ids, size_t max_calls, flag_t flags);
void write_output_files(const char *argv[], FILE *vcf_infile, const char *sample_ids[], _Bool selected[], const char *prefix, size_t first_col, size_t last_col, size_t max_calls, flag_t flags);
