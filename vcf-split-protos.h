...
int split_line(char *argv[], FILE *vcf_infile, FILE *vcf_outfiles[], const char *all_sample_ids[], _Bool selected[], size_t first_col, size_t last_col, size_t max_calls, flag_t flags, vcf_field_mask_t field_mask);
